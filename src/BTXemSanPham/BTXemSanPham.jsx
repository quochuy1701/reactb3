...
export default class BTXemSanPham extends Component {
    mangShoe =
        [
            {
                "id": 1,
   ...
   xemChitiet = (Thongtin) => {
        this.setState({
            shoeChitiet :Thongtin,
        })
   }
    render() {
        return (
            <div className='container'>
                <ProDuctList mangShoe={this.mangShoe} xemChitiet={this.xemChitiet} />
                <XemChiTiet shoeChitiet={this.state.shoeChitiet}/>
            </div>
        )
    }
}
